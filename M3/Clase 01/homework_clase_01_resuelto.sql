...
LOAD DATA INFILE 'D:\Matt\Henry\Homeworks\M3\Clase 01\Homework\Gasto.csv'
INTO TABLE `gasto` 
...
LOAD DATA INFILE 'D:\Matt\Henry\Homeworks\M3\Clase 01\Homework\Compra.csv' 
INTO TABLE `compra` 
FIELDS TERMINATED BY ',' ENCLOSED BY '' ESCAPED BY '' 
LINES TERMINATED BY '\n' IGNORE 1 LINES;
...
LOAD DATA INFILE 'D:\Matt\Henry\Homeworks\M3\Clase 01\Homework\Venta.csv' 
INTO TABLE `venta` 
FIELDS TERMINATED BY ',' ENCLOSED BY '' ESCAPED BY '' 
LINES TERMINATED BY '\r\n' IGNORE 1 LINES;
...
LOAD DATA INFILE 'D:\Matt\Henry\Homeworks\M3\Clase 01\Homework\CanalDeVenta.csv' 
...
LOAD DATA INFILE 'D:\Matt\Henry\Homeworks\M3\Clase 01\Homework\TiposDeGasto.csv' 
...
LOAD DATA INFILE 'D:\Matt\Henry\Homeworks\M3\Clase 01\Homework\Clientes.csv'
INTO TABLE cliente
FIELDS TERMINATED BY ';' ENCLOSED BY '\"' ESCAPED BY '\"' 
LINES TERMINATED BY '\n' IGNORE 1 LINES;
...
LOAD DATA INFILE 'D:\Matt\Henry\Homeworks\M3\Clase 01\Homework_Resuelto\Proveedores.csv' 
...
LOAD DATA INFILE 'D:\Matt\Henry\Homeworks\M3\Clase 01\Homework_Resuelto\Productos.csv' 
INTO TABLE `producto` 
FIELDS TERMINATED BY ',' ENCLOSED BY '\"' ESCAPED BY '\"' 
LINES TERMINATED BY '\n' IGNORE 1 LINES;
...
LOAD DATA INFILE 'D:\Matt\Henry\Homeworks\M3\Clase 01\Homework_Resuelto\Empleados.csv' 
INTO TABLE `empleado` 
FIELDS TERMINATED BY '|' ENCLOSED BY '\"' ESCAPED BY '\"' 
LINES TERMINATED BY '\n' IGNORE 1 LINES;
...
LOAD DATA INFILE 'D:\Matt\Henry\Homeworks\M3\Clase 01\Homework_Resuelto\Sucursales.csv' 
INTO TABLE sucursal
FIELDS TERMINATED BY ';' ENCLOSED BY '\"' ESCAPED BY '\"' 
LINES TERMINATED BY '\n' IGNORE 1 LINES;
