...
El término <b>estadística se refiere a datos numéricos, tales como promedios, medianas, porcentajes y números índices</b> que ayudan a entender una gran variedad situaciones.<br>
...
<b>En muchas situaciones se requiere información acerca de grupos grandes de elementos</b> (individuos, empresas, votantes, hogares, productos, clientes, etc.). Pero, debido al tiempo, costo y a otras consideraciones, sólo es posible recolectar los datos de una pequeña parte de este grupo. <b>Al grupo grande de elementos</b> en un determinado estudio <b>se le llama población</b> y <b>al grupo pequeño muestra</b>. En términos formales se emplean las definiciones siguientes. <br>
<b>Al proceso de realizar un estudio para recolectar datos de toda una población se le llama censo</b>. Al proceso de efectuar un estudio para <b>recolectar datos de una muestra se le llama encuesta muestral</b>. <b>Una de las principales contribuciones de la estadística es emplear datos de una muestra para hacer estimaciones y probar hipótesis acerca de las características de una población mediante un proceso al que se le conoce como inferencia estadística.</b>
